...
class FruitData {
  static List<FruitInfo> fruits = [
    ...
    FruitInfo(
      ...
      definition: 'A tropical fruit with a tough brownish-yellow rind and sweet flesh.',
    ),
    FruitInfo(
      name: 'Watermelon',
    ...
    FruitInfo(
      ...
      definition: 'A brown fuzzy fruit with bright green flesh and tiny black seeds.',
    ),
    FruitInfo(
      name: 'Blueberry',
      frenchTranslation: 'Myrtille',
      arabicTranslation: 'توت أزرق',
      definition: 'Small round blue fruits that grow on bushes and are rich in antioxidants.',
    ),
    FruitInfo(
      name: 'Papaya',
      frenchTranslation: 'Papaye',
      arabicTranslation: 'بابايا',
      definition: 'A tropical fruit with orange flesh and black seeds in the center.',
    ),
    FruitInfo(
      name: 'Cherry',
      frenchTranslation: 'Cerise',
      arabicTranslation: 'كرز',
      definition: 'A small round stone fruit with red or black skin and sweet flesh.',
    ),
  ];
